  ...
  return (
    <section className="bg-secondary p-6 font-body text-secondary sm:p-14">
      <div className="b2 grid grid-cols-1 lg:grid-cols-5 lg:gap-4">
        <div className="b3 grid text-justify lg:col-span-4 lg:grid lg:grid-cols-2 lg:gap-10">
          <div id="text1" className="b4 order-1 text-xs md:text-sm lg:relative lg:col-span-1">
            <p>
          ...
          <div className="b5 order-2 lg:order-2 lg:col-span-1">
            <p id="text3" className="b4 order-1 mt-10 text-xs md:text-sm lg:relative lg:top-10 lg:mt-0">
            ...
            <h3 id="heading_bookup" className="b4 order-last mt-10 font-heading text-3xl md:text-5xl lg:relative lg:top-20 lg:order-2 lg:mt-20 xl:text-6xl">
              découvrez <br />
              notre équipe !
            </h3>
          </div>
        </div>
        <div id="CTAs" className="b4 mx-auto my-16 flex flex-row justify-center gap-8 md:col-span-1 lg:my-auto lg:flex-col lg:gap-10">
